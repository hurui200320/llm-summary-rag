 ...
 * for [summaryLength] chars of output.
 * */
fun generateChatRequest(
 ...
 * */
fun preprocessXML(text: String): String {
 ...
 * */
fun createChunkSummarySystemPrompt(summaryLength: Int) = """
    |# Role
    |你是一位专业的中文小说摘要专家。
 ...
 * */
fun createBookSummarySystemPrompt(summaryLength: Int) = """
    |# Role
    |你是一位文学编辑。
